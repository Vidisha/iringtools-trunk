...
public class RoleDefinition {
    ...
    public static Comparator<RoleDefinition> sortAscending()
    {
      RoleDefinition x = new RoleDefinition();
   	  return (Comparator<RoleDefinition>)x.new sortAscendingHelper();
    }
    private class sortAscendingHelper implements Comparator<RoleDefinition>
    {
    	@Override
    	public int compare(RoleDefinition e1, RoleDefinition e2) {
    		return e1.getNames().get(0).value.compareTo(e2.getNames().get(0).value);
    	}
    }
}
