 ...
 *         &lt;element name="entity-type" type="{http://ns.ids-adi.org/qxf/model#}EntityType"/>
 *         &lt;element name="classification" type="{http://ns.ids-adi.org/qxf/model#}Classification" maxOccurs="unbounded"/>
...
@XmlType(name = "ClassDefinition", propOrder = {
    "repository",
    "entityType",
    "classifications",
    "specializations",
