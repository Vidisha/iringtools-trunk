...
public abstract class AbstractService
{
  ...
  public void initService(String serviceName) throws AuthorizationException
  {
    ...
    String tipServiceUri = servletContext.getInitParameter("TipServiceUri");
    if (tipServiceUri == null || tipServiceUri.equals(""))
      tipServiceUri = "http://localhost:8080/services/tip";
    settings.put("tipServiceUri", tipServiceUri);
    /*
