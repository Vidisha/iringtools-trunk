...
@XmlRootElement(name = "ordinalList")
    ...
    implements Serializable
{
     ...
     * 
     */
    public List<Ordinal> getItems() {
        if (items == null) {
            items = new ArrayList<Ordinal>();
        }
        return this.items;
    }
     ...
     *     
     */
    public void setItems(List<Ordinal> items) {
        this.items = items;
    }
