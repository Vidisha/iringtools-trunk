...
@XmlRootElement(name = "commodityTipList")
    ...
    implements Serializable
{
    ...
    protected List<CommodityTip> items;
     ...
     * 
     */
    public List<CommodityTip> getItems() {
        if (items == null) {
            items = new ArrayList<CommodityTip>();
        }
        return this.items;
    }
     ...
     *     
     */
    public void setItems(List<CommodityTip> items) {
        this.items = items;
    }
