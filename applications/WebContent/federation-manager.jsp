...
<head>
  ...
  <script type="text/javascript" src="resources/scripts/SearchPanel.js"></script>
  <script type="text/javascript" src="resources/scripts/FederationPanel.js"></script>
  <script type="text/javascript" src="resources/scripts/ClassTemplatePanel.js"></script>
  <script type="text/javascript" src="resources/scripts/EditTemplateRole.js"></script>
  <script type="text/javascript" src="resources/scripts/ContentPanel.js"></script>
  <script type="text/javascript" src="resources/scripts/FederationManager.js"></script>
</head>
<body>
  <div id="header" class="exchangeBanner">
    <span style="float:left">
      <img src="resources/images/iringlogo-big.png" 
        ...
        style="font-family: Arial, Helvetica, Sans-Serif">Federation Manager</font></span>
    </span>
    <span style="float:right;margin:18px 36px 1px 0"><a
        href="hhttp://iringug.org/wiki/index.php?title=IRINGTools" target="_blank"  class="headerLnkBlack">Help</a>&nbsp;&nbsp;&nbsp;&nbsp;<a 
