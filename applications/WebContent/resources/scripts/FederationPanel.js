          ...
          for (var i in properties) {
            ...
            switch (fname) {
	              ...
	              case 'Namespace List':
	                ...
	                listItem.imagePath = './resources/ext-3.4.0/ux/images/';
        	  ...
        	  buildRepoDisContextMenu: function () {
                  ...
                  onDelete : function() {
                      ...
                      if (node.hasChildNodes()) {
                    	...
                    	var message = 'Please select a node!';
                                  ...
                                  Ext.Ajax
                                      .request( {
                                        ...
                                        success : function(o) {
                                          ...
                                          var message = 'Node has been deleted';
                              	    	  showDialog(400, 100, 'Sucess', message, Ext.Msg.OK, null);
