...
@XmlRootElement(name = "patternsList")
    ...
    implements Serializable
{
     ...
     * 
     */
    public List<Patterns> getItems() {
        if (items == null) {
            items = new ArrayList<Patterns>();
        }
        return this.items;
    }
     ...
     *     
     */
    public void setItems(List<Patterns> items) {
        this.items = items;
    }
