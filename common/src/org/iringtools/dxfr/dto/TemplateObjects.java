...
public class TemplateObjects {
    ...
    protected List<TemplateObject> items;
     ...
     * 
     */
    public List<TemplateObject> getItems() {
        if (items == null) {
            items = new ArrayList<TemplateObject>();
        }
        return this.items;
    }
     ...
     *     
     */
    public void setItems(List<TemplateObject> items) {
        this.items = items;
    }
